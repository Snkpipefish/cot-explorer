...
ENSO_IMPACTS = {
    ...
    ("El Niño", "vietnam_robusta"):  {"impact": "Tørke ved blomstring", "adj": 0.5},
    ("El Niño", "thailand_sugar"):   {"impact": "Tørke under vekst", "adj": 0.5},
    ("El Niño", "ivory_coast_cocoa"):{"impact": "Tørrere enn normalt", "adj": 0.4},
    ("El Niño", "ghana_cocoa"):      {"impact": "Tørrere enn normalt", "adj": 0.4},
    ...
    ("La Niña", "vietnam_robusta"):   {"impact": "Gunstig regn", "adj": -0.2},
    ("La Niña", "thailand_sugar"):    {"impact": "Gunstig monsun", "adj": -0.2},
    ("La Niña", "ivory_coast_cocoa"): {"impact": "Mer regn (svartrate-risiko)", "adj": 0.2},
    ("La Niña", "ghana_cocoa"):       {"impact": "Mer regn (svartrate-risiko)", "adj": 0.2},
}
...
REGION_CROPS = {
    ...
    "sea_palm":          ["palm"],
    "vietnam_robusta":   ["coffee"],
    "thailand_sugar":    ["sugar"],
    "ivory_coast_cocoa": ["cocoa"],
    "ghana_cocoa":       ["cocoa"],
